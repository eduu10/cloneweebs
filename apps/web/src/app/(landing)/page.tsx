...
const AVATAR_SHOWCASE = [
  {
    name: "Sofia",
    role: "Apresentadora Corporativa",
...
const BENTO_FEATURES: readonly BentoFeature[] = [
  {
    icon: Users,
    title: "500+ Avatares Hiper-Realistas",
    description:
      "Biblioteca com centenas de avatares diversos em gênero, etnia e estilo. Ou crie seu próprio clone digital com apenas 2 minutos de vídeo.",
    tag: "Mais popular",
    span: "md:col-span-2 md:row-span-2",
    img: "https://images.unsplash.com/photo-1535303311164-664fc9ec6532?w=800&h=500&fit=crop",
  },
  {
    icon: Wand2,
    title: "Video Agent IA",
    description:
      "Descreva em texto o que precisa e nosso agente inteligente cria o vídeo completo automaticamente.",
    tag: "Novo",
    span: "md:col-span-1",
  ...
  },
  {
    ...
    description:
      "Clone de voz com fidelidade de 99%. Mais de 400 vozes em 175 idiomas.",
    span: "md:col-span-1",
    img: "https://images.unsplash.com/photo-1478737270239-2f02b77fc618?w=600&h=300&fit=crop",
  },
  {
    icon: Film,
    title: "AI Studio Pro",
    description:
      "Editor profissional com templates, cenas, legendas automáticas, trilha sonora IA e transições cinematográficas.",
    span: "md:col-span-1",
    img: "https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=600&h=300&fit=crop",
  },
  {
    icon: Languages,
    title: "Tradução + Lip Sync",
    description:
      "Traduza vídeos para 175+ idiomas com sincronização labial perfeita. Um vídeo, alcance global.",
    span: "md:col-span-1",
  ...
  },
  {
    ...
    description:
      "SOC 2 Type II, LGPD, SSO, API robusta e SLA garantido. Pronto para escalar com sua empresa.",
    span: "md:col-span-2",
    img: "https://images.unsplash.com/photo-1563986768609-322da13575f2?w=800&h=300&fit=crop",
  },
] as const;
...
const STEPS = [
  {
    ...
    description:
      "Selecione da biblioteca ou crie seu clone digital personalizado em minutos.",
    icon: Users,
  },
  {
    step: "02",
    title: "Escreva ou Cole o Script",
    description:
      "Digite seu texto ou deixe a IA gerar o roteiro perfeito para você.",
    icon: MessageSquare,
  },
  {
    step: "03",
    ...
    description:
      "Vídeo profissional em 4K pronto em menos de 2 minutos. Exporte e publique.",
    icon: Video,
  },
] as const;
...
const USE_CASES = [
  {
    ...
    description: "Anúncios personalizados, demos de produto, depoimentos em escala.",
    img: "https://images.unsplash.com/photo-1551434678-e076c223a692?w=600&h=400&fit=crop",
    stats: "3x mais conversão",
  },
  {
    title: "Treinamento & RH",
    description: "Onboarding, compliance, treinamentos atualizados sem regravar.",
    img: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=600&h=400&fit=crop",
    stats: "70% menos custo",
  },
  {
    title: "Educação & Cursos",
    description: "Aulas envolventes com avatares, multilíngue e acessíveis.",
    img: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=600&h=400&fit=crop",
    stats: "2x retenção",
  },
  {
    title: "Atendimento ao Cliente",
    description: "Vídeos personalizados de suporte, tutoriais e FAQ interativo.",
    img: "https://images.unsplash.com/photo-1556745757-8d76bdb6984b?w=600&h=400&fit=crop",
    stats: "50% menos tickets",
  },
] as const;

const LOGOS = [
  "Nubank", "iFood", "Mercado Livre", "Magazine Luiza",
  "Itaú", "Ambev", "Globo", "VTEX",
  "Stone", "PagBank", "Totvs", "Locaweb",
] as const;
...
const PLANS: readonly PricingPlan[] = [
  ...
  },
  {
    ...
    features: [
      "15 minutos de vídeo/mês",
      "50 avatares premium",
      "Resolução Full HD",
      "Sem marca d'água",
      "5 idiomas para tradução",
      "Video Agent (5 usos/mês)",
    ],
    cta: "Assinar Creator",
    highlighted: false,
  },
  {
    ...
    price: "R$ 149",
    period: "/mês",
    description: "Para empresas e equipes de conteúdo",
    features: [
      "60 minutos de vídeo/mês",
      "Todos os 500+ avatares",
      "Resolução 4K Ultra HD",
      "Clone digital personalizado",
      "175+ idiomas com lip sync",
      "Video Agent ilimitado",
      "API de integração",
      "Suporte prioritário",
    ],
    cta: "Assinar Pro",
...
/* ============================================================
   THEME COLORS — conditional classes for dark/light
   ============================================================ */

const T = {
  // Text
  textPrimary: "text-green-400 dark:text-green-400",
  textHeading: "text-white dark:text-white light:text-gray-900",
  textBody: "text-white/50 dark:text-white/50",
  textMuted: "text-white/30 dark:text-white/30",
  // BG
  bgPrimary: "bg-green-500",
  bgPrimarySubtle: "bg-green-500/10 dark:bg-green-500/10",
  // Border
  borderPrimary: "border-green-500/20 dark:border-green-500/20",
} as const;
    ...
    <div className="relative flex min-h-screen flex-col overflow-x-hidden">
      ...
      <header className="glass-strong sticky top-0 z-50">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            {["Funcionalidades", "Como Funciona", "Casos de Uso", "Preços"].map(
              (label) => (
                <a
                  key={label}
          ...
          <div className="hidden items-center gap-3 md:flex">
            ...
            <Button
              variant="ghost"
              className={cn(isDark ? "text-white/70 hover:bg-white/5 hover:text-white" : "text-gray-600 hover:bg-gray-100 hover:text-gray-900")}
              asChild
            >
          ...
          <div className="flex items-center gap-2 md:hidden">
            <button
              onClick={toggleTheme}
              className={cn("flex h-9 w-9 items-center justify-center rounded-lg", isDark ? "text-white/60" : "text-gray-500")}
              aria-label="Alternar tema"
            >
              {isDark ? <Sun className="h-4 w-4" /> : <Moon className="h-4 w-4" />}
            </button>
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden pt-16 pb-24 sm:pt-24 sm:pb-36 lg:pt-28 lg:pb-44">
          ...
          <div className="absolute left-1/2 top-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full bg-emerald-500/6 blur-[80px] animate-float-slow" />

          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              {/* Badge — no extra space above */}
              <div className={cn(
              ...
              <h1 className={cn(
                ...
                Transforme texto em{" "}
                <span className={cn("gradient-text", isDark && "animate-text-glow")}>
                  vídeos com avatares IA
                </span>{" "}
                em minutos
              </h1>
              ...
              <div className="animate-slide-up delay-300 mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
                ...
                <Button
                  ...
                  variant="outline"
                  className={cn(
                    "h-14 gap-2.5 rounded-xl px-8 text-base font-semibold backdrop-blur-sm",
                    isDark ? "border-white/10 bg-white/5 text-white hover:bg-white/10" : "border-gray-200 bg-white text-gray-900 hover:bg-gray-50"
                  )}
                >
              ...
              <div className="animate-scale-in delay-500 relative mx-auto mt-20 max-w-5xl">
                <div className={cn(
                  ...
                  isDark ? "border-green-500/10 shadow-green-500/5" : "border-gray-200 shadow-green-500/10"
                )}>
                  ...
                  <div className={cn("relative aspect-video w-full overflow-hidden rounded-2xl", isDark ? "bg-black" : "bg-gray-100")}>
                    <img
                      ...
                      alt="CloneWeebs IA Platform Demo"
          ...
          <div className="relative">
            ...
            <div className="flex animate-marquee items-center gap-16">
              {[...LOGOS, ...LOGOS].map((logo, i) => (
                <span
                  key={`${logo}-${i}`}
                  className={cn("shrink-0 text-lg font-bold tracking-wide transition-colors", isDark ? "text-white/15 hover:text-white/30" : "text-gray-200 hover:text-gray-400")}
                >
                  {logo}
                </span>
              ))}
        ...
        <section className="relative py-20 sm:py-28">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <span className={cn(
                "inline-block rounded-full border px-4 py-1 text-xs font-semibold uppercase tracking-wider",
                isDark ? "border-green-500/20 bg-green-500/10 text-green-400" : "border-green-500/30 bg-green-50 text-green-700"
              )}>
                Avatares
              </span>
              <h2 className={cn("mt-4 text-3xl font-bold sm:text-5xl", isDark ? "text-white" : "text-gray-900")}>
                Conheça seus novos{" "}
                <span className="gradient-text-cyan">apresentadores</span>
              </h2>
              <p className={cn("mx-auto mt-4 max-w-2xl", isDark ? "text-white/40" : "text-gray-500")}>
                ...
                Diversos em gênero, etnia, idade e estilo.
              </p>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h2 className={cn("mt-4 text-3xl font-bold sm:text-5xl", isDark ? "text-white" : "text-gray-900")}>
                ...
                <span className={isDark ? "text-white/40" : "text-gray-400"}>Nada que não precisa.</span>
              </h2>
            </div>
            ...
            <div className="mt-16 grid gap-4 md:grid-cols-4">
              {BENTO_FEATURES.map((feature) => (
                <div
                  key={feature.title}
                  className={cn(
                    "group relative overflow-hidden rounded-2xl border p-6 transition-all hover-lift",
                    feature.span,
                    isDark
                      ? "border-white/5 bg-white/[0.02] hover:border-green-500/20 hover:bg-white/[0.04]"
                      : "border-gray-200 bg-white hover:border-green-500/30 hover:shadow-lg"
                  )}
                >
                  {/* Hover gradient */}
                  ...
                  <div className="relative z-10">
                    {feature.tag && (
                      <span className={cn(
                        "mb-4 inline-block rounded-full px-3 py-0.5 text-xs font-semibold",
                    ...
                    <h3 className={cn("mt-4 text-lg font-semibold", isDark ? "text-white" : "text-gray-900")}>
                      {feature.title}
                    </h3>
                    <p className={cn("mt-2 text-sm leading-relaxed", isDark ? "text-white/40" : "text-gray-500")}>
                      {feature.description}
                    </p>
                  </div>
              ...
              {STEPS.map((step) => (
                <div key={step.step} className="group relative text-center">
                  <div className="relative mx-auto mb-8">
                    <div className={cn(
                      "mx-auto flex h-32 w-32 items-center justify-center rounded-3xl border transition-all",
                      isDark
                        ? "border-white/10 bg-white/[0.02] group-hover:border-green-500/20 group-hover:bg-white/[0.05]"
                        : "border-gray-200 bg-white group-hover:border-green-500/30 group-hover:shadow-lg"
                    )}>
                  ...
                  <p className={cn("mx-auto mt-3 max-w-xs text-sm leading-relaxed", isDark ? "text-white/40" : "text-gray-500")}>
                    {step.description}
                  </p>
                </div>
              ))}
        ...
        <section id="casos-de-uso" className="py-20 sm:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h2 className={cn("mt-4 text-3xl font-bold sm:text-5xl", isDark ? "text-white" : "text-gray-900")}>
                Um vídeo vale mais que{" "}
                <span className="gradient-text">mil reuniões</span>
              </h2>
            </div>
              ...
              {USE_CASES.map((useCase) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <span className="inline-block rounded-full bg-green-500/20 px-3 py-0.5 text-xs font-semibold text-green-300 backdrop-blur-sm">
                      {useCase.stats}
                    </span>
                  ...
                  className={cn(
                    ...
                    plan.highlighted
                      ? isDark
                        ...
                        : "border-green-500/40 bg-green-50/50 shadow-xl shadow-green-500/10"
                      : isDark
                        ? "border-white/5 bg-white/[0.02] hover:border-white/10"
                        : "border-gray-200 bg-white hover:border-green-500/30"
                  )}
                >
                  {plan.badge && (
                    <div className="absolute -top-px left-0 right-0">
                      <div className="mx-auto w-fit rounded-b-lg bg-green-500 px-4 py-1 text-xs font-semibold text-black">
                        {plan.badge}
                      </div>
                    </div>
                  )}
                  ...
                  <div className="mt-6 flex items-baseline gap-1">
                    ...
                    {plan.period && (
                      <span className={cn("text-sm", isDark ? "text-white/40" : "text-gray-400")}>{plan.period}</span>
                    )}
                  </div>
                  ...
                  <Button
                    className={cn(
                      ...
                      plan.highlighted
                        ? "bg-green-500 text-black font-semibold shadow-lg shadow-green-500/25 hover:bg-green-400"
                        : isDark
        ...
        <section className="relative overflow-hidden py-28 sm:py-36">
          ...
          <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <p className={cn("mx-auto mt-6 max-w-xl text-lg", isDark ? "text-white/40" : "text-gray-500")}>
              Junte-se a mais de 10.000 criadores e empresas que já transformaram
              sua comunicação com CloneWeebs IA.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <ul className="mt-4 space-y-2.5">
                  {links.map((link) => (
                    <li key={link}>
                      <a
                        href="#"
                        className={cn("text-sm transition-colors", isDark ? "text-white/30 hover:text-white/60" : "text-gray-400 hover:text-gray-600")}
                      >
                        {link}
                      </a>
                    </li>
          ...
          <div className={cn("mt-16 flex flex-col items-center justify-between gap-4 border-t pt-8 sm:flex-row", isDark ? "border-white/5" : "border-gray-200")}>
            <p className={cn("text-sm", isDark ? "text-white/20" : "text-gray-400")}>
              &copy; {new Date().getFullYear()} CloneWeebs IA. Todos os direitos
              reservados.
            </p>
            <div className="flex gap-6">
              {["Twitter", "LinkedIn", "YouTube", "Instagram"].map((social) => (
                <a
                  key={social}
                  href="#"
                  className={cn("text-sm transition-colors", isDark ? "text-white/20 hover:text-white/50" : "text-gray-400 hover:text-gray-600")}
                >
                  {social}
                </a>
              ))}
